...
#=====[ LEAVE GROUP OR ROOM ]==========
    ...
    if text == 'Mbw bye' or text == 'mmbw bye':
        if isinstance(event.source, SourceGroup):
            line_bot_api.reply_message(
    ...
    if text == 'morning' or text == 'Morning' or text == 'Sobh be khir' or text == 'Selamat pagi':
        if isinstance(event.source, SourceGroup):
            line_bot_api.reply_message(
                event.reply_token, TextSendMessage(text='Morning too, Sis, breakfast and happy activities..(-_-)...!!!'))
            #line_bot_api.leave_group(event.source.group_id)
        elif isinstance(event.source, SourceRoom):
            line_bot_api.reply_message(
                event.reply_token, TextSendMessage(text='Morning too, Sis, breakfast and happy activities..(-_-)...!!!'))
    ...
    if text == 'afternoon' or text == 'Afternoon' or text == 'Met siang' or text == 'Selamat siang':
        if isinstance(event.source, SourceGroup):
            line_bot_api.reply_message(
                event.reply_token, TextSendMessage(text='The afternoon is good after lunch too..(-_-)...!!!'))
            #line_bot_api.leave_group(event.source.group_id)
        elif isinstance(event.source, SourceRoom):
            line_bot_api.reply_message(
                event.reply_token, TextSendMessage(text='The afternoon is good after lunch too..(-_-)...!!!'))
    ...
    if text == 'Night' or text == 'night' or text == 'Met mlm' or text == 'Selamat mlm' or text == 'Selamat malam' or text == 'Met malam':
        if isinstance(event.source, SourceGroup):
            line_bot_api.reply_message(
                event.reply_token, TextSendMessage(text='Night too Sis, Good Night Sis, have a nice dream..(-_-)...!!!'))
            #line_bot_api.leave_group(event.source.group_id)
        elif isinstance(event.source, SourceRoom):
            line_bot_api.reply_message(
                event.reply_token, TextSendMessage(text='Night too Sis, Good Night Sis, have a nice dream..(-_-)...!!!'))
...
#=====[ TEMPLATE MESSAGE ]=============
        ...
        line_bot_api.reply_message(event.reply_token, message)
#===========================================================
    elif text == 'MBW help':#template
        buttons_template = TemplateSendMessage(
            alt_text='mosn',
            template=ButtonsTemplate(
                title='[ MOHSEN.BW ]',
                text= 'mosn Bot => Owner : mosn',
                actions=[
        ...
        buttons_template = TemplateSendMessage(
            ...
            template=ButtonsTemplate(
                ...
                actions=[
                    ...
                    MessageTemplateAction(
                        label='Logo/Cover MBW',
                        text='Logofjs123fjs'
                    ),
                    MessageTemplateAction(
                        label='Struktur MBW',
                        text='StrukturKepengurusanMBW'
                    )
                ]
            )
        )
        line_bot_api.reply_message(event.reply_token, buttons_template)
    elif text == 'mosen593':#template
        buttons_template = TemplateSendMessage(
            alt_text='mosn',
            template=ButtonsTemplate(
                title='[ FAMILY JAVANESE SMULE ]',
                ...
                actions=[
                    ...
                    MessageTemplateAction(
                        label=' MBW MBW 2',
                        text='K MBW MBWngurusanfjs123fjs2'
                    ),
                    MessageTemplateAction(
                        label=' MBW 3',
...
#=======================================================================================================================
                ...
                contents=[
                    ...
                    BoxComponent(
                        ...
                        contents=[
                            ...
                            IconComponent(size='sm', url='https://www.thespaatlittleriver.com/wp-content/uploads/2013/07/gold-star.jpg'),
                            IconComponent(size='sm', url='https://www.thespaatlittleriver.com/wp-content/uploads/2013/07/gold-star.jpg'),
                            TextComponent(text='Owner: mosn', size='sm', color='#999999', margin='md',
                                          flex=0)
                        ]
                    ),
                    # info
            ...
            footer=BoxComponent(
                ...
                contents=[
                    ...
                    ButtonComponent(
                        style='link',
                        height='sm',
                        action=URIAction(label='mosn', uri="https://line.me/ti/p/~masih.00")
                    )
                ]
            ),
        )
        message = FlexSendMessage(alt_text="Kontak1 mosn", contents=bubble)
        line_bot_api.reply_message(
            event.reply_token,
            message
        )
        ...
        bubble = BubbleContainer(
            ...
            body=BoxComponent(
                ...
                contents=[
                    # title
                    TextComponent(text='mosn', weight='bold', size='xl'),
                    # review
                    BoxComponent(
                        layout='baseline',
                        margin='md',
        ...
        message = FlexSendMessage(alt_text="Kontak2 mosn", contents=bubble)
        line_bot_api.reply_message(
            event.reply_token,
            message
        )
                ...
                contents=[
                    ...
                    BoxComponent(
                        ...
                        contents=[
                            ...
                            IconComponent(size='sm', url='https://www.thespaatlittleriver.com/wp-content/uploads/2013/07/gold-star.jpg'),
                            IconComponent(size='sm', url='https://www.thespaatlittleriver.com/wp-content/uploads/2013/07/gold-star.jpg'),
                            TextComponent(text='MBW', size='sm', color='#999999', margin='md',
                                          flex=0)
                        ]
                    ),
                    # info
            ...
            footer=BoxComponent(
                ...
                contents=[
                    ...
                    ButtonComponent(
                        style='link',
                        height='sm',
                        action=URIAction(label='Contact mosn', uri="https://line.me/ti/p/~masih.00")
                    )
                ]
            ),
        )
            ...
            footer=BoxComponent(
                ...
                contents=[
                    ...
                    ButtonComponent(
                        style='link',
                        height='sm',
                        action=URIAction(label='Contact Cinta', uri="https://line.me/ti/p/~masih.00")
                    )
                ]
            ),
        )
            ...
            footer=BoxComponent(
                ...
                contents=[
                    ...
                    ButtonComponent(
                        style='link',
                        height='sm',
                        action=URIAction(label='Contact Tria', uri="https://line.me/ti/p/~masih.00")
                    )
                ]
            ),
        )
            ...
            footer=BoxComponent(
                ...
                contents=[
                    ...
                    ButtonComponent(
                        style='link',
                        height='sm',
                        action=URIAction(label='Contact Hajir', uri="https://line.me/ti/p/~masih.00")
                    )
                ]
            ),
        )
            ...
            footer=BoxComponent(
                ...
                contents=[
                    ...
                    ButtonComponent(
                        style='link',
                        height='sm',
                        action=URIAction(label='Contact Leonardo', uri="https://line.me/ti/p/~masih.00")
                    )
                ]
            ),
        )
            ...
            footer=BoxComponent(
                ...
                contents=[
                    ...
                    ButtonComponent(
                        style='link',
                        height='sm',
                        action=URIAction(label='Contact Kweni', uri="https://line.me/ti/p/~masih.00")
                    )
                ]
            ),
        )
            ...
            footer=BoxComponent(
                ...
                contents=[
                    ...
                    ButtonComponent(
                        style='link',
                        height='sm',
                        action=URIAction(label='Contact Alyn', uri="https://line.me/ti/p/~masih.00")
                    )
                ]
            ),
        )
