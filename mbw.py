...
line_bot_api = LineBotApi('6j0N0JbftHhxK8uw+GGFlIpHESWkPzbAL3/1KwgEhzi/y7J70r4S73+amynaPwrKhHGfZ9DyIYVwOzdxG/VTdXLkxPT3WEUlQyDh823DPssABWArVeffolIWs5QmjYoaxh84Wpn5E+fVy6CEenIPNQdB04t89/1O/w1cDnyilFU=')
# Channel Secret
handler = WebhookHandler('47391a23afc1d28f15b23899a6440882')
...
â•”â•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گ
â•‘âک›FAMILY JAVANESE SMULEâکڑ'
â• â•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گ
â•‘OWNER :
â•‘KRIS
â•‘
...
â• â•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گ
â•‘âک›FAMILY JAVANESE SMULEâکڑ
â•ڑâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گâ•گ
'''))
            #line_bot_api.leave_group(event.source.group_id)
        elif isinstance(event.source, SourceRoom):
            line_bot_api.reply_message(
            ...
            footer=BoxComponent(
                ...
                contents=[
                    ...
                    ButtonComponent(
                        style='link',
                        height='sm',
                        action=URIAction(label='Kris', uri="https://line.me/ti/p/~masih.00")
                    )
                ]
            ),
        )
            ...
            footer=BoxComponent(
                ...
                contents=[
                    ...
                    ButtonComponent(
                        style='link',
                        height='sm',
                        action=URIAction(label='Contact Kris', uri="https://line.me/ti/p/~masih.00")
                    )
                ]
            ),
        )
